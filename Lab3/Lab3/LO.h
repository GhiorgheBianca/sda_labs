...
//se defineste tipul Pointer_toNod ca fiind adresa unui Nod
typedef Nod* Pointer_toNod;

class Nod {
private:
	TElement element;
	//o singura legatura - lista simplu inlantuita
	Pointer_toNod urmator;

public:
	friend class LO;

	TElement getElement();
	Pointer_toNod getUrmator();
	Nod(TElement element, Pointer_toNod urmator);
...
private:
	/* aici reprezentarea */
	//primul element din LSI
	Pointer_toNod primul;
	//relatia de ordine dintre elemente
	Relatie rel;
...
public:
	...
	Iterator ultimulIterator(TElement elem) const;
